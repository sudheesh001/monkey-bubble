...
static void
mb_net_message_init (MbNetMessage * self)
{
  Private *priv;
...
static void
mb_net_message_finalize (MbNetMessage * self)
{
  Private *priv;
  priv = GET_PRIVATE (self);
...
MbNetMessage *
mb_net_message_create_from (const guint8 * data, guint32 size)
{
  Private *priv;
...
guint32
mb_net_message_size (MbNetMessage * self)
{
  Private *priv;
  priv = GET_PRIVATE (self);
...
const guint8 *
mb_net_message_data (MbNetMessage * self)
{
  Private *priv;
  priv = GET_PRIVATE (self);
...
void
mb_net_message_add_int (MbNetMessage * self, guint32 value)
{
  Private *priv;
  priv = GET_PRIVATE (self);
...
void
mb_net_message_add_boolean (MbNetMessage * self, gboolean value)
{
  Private *priv;
  priv = GET_PRIVATE (self);
...
void
mb_net_message_add_string (MbNetMessage * self, const gchar * str)
{
  if (str == NULL)
    return;
  Private *priv;
...
void
mb_net_message_skip (MbNetMessage * self, guint32 skip_size)
{
  Private *priv;
  priv = GET_PRIVATE (self);
...
guint32
mb_net_message_read_int (MbNetMessage * self)
{
  Private *priv;
  priv = GET_PRIVATE (self);
  guint32 ret = 0;
...
gboolean
mb_net_message_read_boolean (MbNetMessage * self)
{
  Private *priv;
  priv = GET_PRIVATE (self);
  guint8 ret = 0;
...
gchar *
mb_net_message_read_string (MbNetMessage * self)
{
  Private *priv;
  priv = GET_PRIVATE (self);
...
mb_net_message_class_init (MbNetMessageClass * mb_net_message_class)
{
  ...
  g_object_class->finalize = (GObjectFinalizeFunc) mb_net_message_finalize;
